        ...
        <div className="min-h-screen bg-[#0D1B2A] dark grid grid-cols-2 px-2 md:px-0">
            <div className="flex flex-col justify-between pl-12 py-12">
                <p className="text-white text-2xl md:text-5xl text-left font-bold">
                    Instant <span className="text-primary border-2 border-primary p-1 rounded-full">attendance</span> tracking with barcode scans and automated updates
                </p>
                <p className="text-muted-foreground">Record attendance instantly with barcode scans—no manual entry, no delays. Get fast, accurate tracking with automated updates that keep everyone informed. Save time, cut errors, and simplify attendance management.</p>
            ...
            <img src="/hero-background.png" alt="" className="w-full h-screen opacity-50" />
        </div>
    );
};
